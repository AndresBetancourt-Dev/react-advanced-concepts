...
const LikeButton = () => {
  ...
  /**
   * Invalid prop `onClick` supplied to `React.Fragment`.
   * React.Fragment can only have `key` and `children` props.
   */
  return (
    <React.Fragment >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" onClick={() => setLikes(likes + 1)} style={{fill: "yellow"}}>
 ...
 * ```js
 * ReactDOM.render(likeButton, LikeButton);
 * ```
 */
